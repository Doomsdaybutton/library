                            ...
                            <div class="col-md">
                                <div class="btn-group-toggle btn-group-sm">
                                    <label class="btn btn-outline-success mx-1 mb-2" style="width:150px;">
                                        <input type="checkbox" id="group_search" autocomplete="off" onchange="groupSearchCheckbox(true)">Nach Gruppe suchen
                                    </label>
                                </div>
                            </div>
                        </div>
